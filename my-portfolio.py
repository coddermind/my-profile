...
- *School Management System*: Developed a complete school management system with separate portals for admins, teachers, and students. All the important functionalities can be performed on the portal; such as Assigning subjects, Timetable creation, fees, salaries, attendance, assignments etc. For demo the teacher login credentials are Email: teacher1@school.com to teacher6@school.com, Password: teacher123. For demo student login: Email: student1@school.com to student9@school.com, Password: student123. The admin Login credentials cannot be provided here. View in laptop for best experience. [View Demo of School Management System](https://realworkfinancingbroker.pythonanywhere.com/)
